(() => {
    ...
    (() => {
        ...
        document.addEventListener("DOMContentLoaded", (() => {
            document.querySelector(".dollars-block__content");
            ...
            const addAnimationToBottomDollars = () => {
                ...
                for (let i = 1; i <= 18; i++) bottomDollars[i - 1].style.animation = `slideDownBottomDollarsAnimation${i} linear ${animationDownDollars[i - 1]}s infinite,\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tswayBottomDollarsAnimation ease ${animationSwaySpeed[i - 1]}s infinite`;
            };
        }));
